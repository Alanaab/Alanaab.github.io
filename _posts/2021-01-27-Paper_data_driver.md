...
![image-20210126195217684](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126195217684.png)

构造备选函数组合库$\theta(x)$, 线性函数与非线性函数

![image-20210126195435754](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126195435754.png)
...
![image-20210126200859928](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126200859928.png)

考虑虑到通常实验中采集的数据是带有噪声的，用这种简单的方式求导很可能会出现很大的偏差，例如：实验中的数据理论上是以 x 等于 0.5 为对称轴，斜率为 1 的绝对值函数。但是实际采集到的数据有很多毛刺，如下图所示：

![image-20210126200942741](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126200942741.png)
...
![image-20210126201049877](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126201049877.png)

接下来的目的就是要最小化这个函数，理论上就能求出理想的 dx。文中提出了利用梯度下 降的思想。文中提出用拉格朗日乘子法将上式的偏微分方程表示成了以下形式：

![image-20210126201110764](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126201110764.png)
...
![image-20210126202003268](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126202003268.png)
...
![image-20210126202115018](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126202115018.png)

为了探讨随着时间推移，重构系统与真实系统的误差的变化趋势，我们绘制了重构前 后状态变量随时间的变化图，并在两个不同的噪声值η=0:01 和 η=10 下进行对比，对比结 果如下图所示：

![image-20210126202209004](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126202209004.png)
...
![image-20210126202905678](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126202905678.png)
...
![image-20210126203304707](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126203304707.png)

图 7 展示了当只有带噪的状态 x 可观测时，$\eta$变化下误差与时间的关系。同样，由于 洛伦兹吸引子的混沌性质，误差迅速地随着时间增长。然而，即使对于较大的噪声量级， 但方程的形式依然能被准确地构建。

![image-20210126203339096](C:\Users\97803\AppData\Roaming\Typora\typora-user-images\image-20210126203339096.png)
